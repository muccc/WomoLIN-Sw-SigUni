...
namespace siguni
{
      ...
      , public interface::ISignalGetVoltage
   {
      public:
         ...
         void UpdateUnitSignalSetReset( std::string & attKey, std::string & attValue, std::map<std::string_view, std::string> & attAdditionalSettings ) override final;
         void UpdateUnitSignalGetVersion( std::string & attKey, std::string & attValue, std::map<std::string_view, std::string> & attAdditionalSettings  ) override final;
         void UpdateUnitSignalGetVoltage( std::string & attKey, std::string & attValue, std::map<std::string_view, std::string> & attAdditionalSettings  ) override final;
